...
const DepApproveModal = ({
  ...
  const uploadFile = async () => {
    ...
    // };
    const api = {
      Reject: "claimrejectedaudittrail",
      Approved: "PreauthApprovedaudittrail",
      Discharge_Approved: "DischargeApprovedaudittrail",
    };
...
export default DepApproveModal;
